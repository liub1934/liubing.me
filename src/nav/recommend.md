...
- icon: '@websites/30secondsofcode.png'
  name: 30 seconds of code
  desc: 30秒代码片段，针对所有开发需求的短代码片段。
  link: https://www.30secondsofcode.org/

- icon: '@websites/codeimg.png'
  name: Codeimg
  desc: 将代码片段转换成图片。
  link: https://codeimg.io/

- icon: '@websites/juejin.png'
  name: 掘金
  desc: 面向全球中文开发者的技术内容分享与交流平台。
  link: https://juejin.cn/

- icon: '@websites/mdn.jpg'
  name: MDN中文
  desc: MDN开发者文档
...
- icon: '@websites/52pojie.png'
  name: 吾爱破解
  desc: 吾爱破解论坛致力于软件安全与病毒分析的前沿。
  link: https://www.52pojie.cn/

- icon: '@websites/greasyfork.png'
  name: Greasy Fork
  desc: 下载油猴各种脚本，必备收藏。
  link: https://greasyfork.org/zh-CN

- icon: '@websites/tinypng.png'
  name: TinyPng
...
- icon: '@websites/convertio.png'
  name: Convertio
  desc: 文件转换器，将您的文件转换成任意格式。
  link: https://convertio.co/zh/

- icon: '@websites/relationship.png'
  name: 亲戚关系计算器
