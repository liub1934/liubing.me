...
```yaml
- icon: 'https://favicon.liubing.me/huorong.cn.png'
  name: 火绒安全
  desc: 口碑最好的免费杀毒软件/网络防火墙工具。
...
- icon: 'https://favicon.liubing.me/1password.com.png'
  name: 1Password
  desc: 最佳跨平台电脑手机账号密码管理器工具。
  link: https://1password.com/zh-cn/

- icon: 'https://favicon.liubing.me/lastpass.com.png'
  name: LastPass
  desc: 优秀的网络密码帐号管理工具 (自动登录/同步/跨平台/浏览器插件)
  link: https://www.lastpass.com/

- icon: 'https://favicon.liubing.me/spectre.app.png'
  name: Spectre
