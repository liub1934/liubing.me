...
```yaml
- icon: 'https://favicon.liubing.me/devtools.vuejs.org.png'
  name: Vue Devtools
  desc: Vue 项目开发调试工具。
  link: https://devtools.vuejs.org/

- icon: 'https://favicon.liubing.me/baidufe.com.png'
  name: FeHelper
  desc: 内置N多实用的工具。
  link: https://baidufe.com/fehelper/index/index.html

- icon: 'https://favicon.liubing.me/bitwarden.com.png'
  name: Bitwarden
  desc: 免费密码管理器，关键完全开源，可以自己搭建服务。
  link: https://bitwarden.com/

- icon: 'https://favicon.liubing.me/tampermonkey.net.png'
  name: Tampermonkey(油猴)
  desc: 不必多介绍了，神级插件。
  link: https://tampermonkey.net/

- icon: 'https://favicon.liubing.me/getadblock.com.png'
  name: AdBlock
  desc: 老牌广告拦截插件。
  link: https://getadblock.com/

- icon: 'https://favicon.liubing.me/wappalyzer.com.png'
  name: Wappalyzer
  desc: 一款能够分析目标网站所采用的技术的插件。
  link: https://wappalyzer.com/

- icon: 'https://favicon.liubing.me/chrome.google.com.png'
  name: 网站图标探测器
  desc: 探测网站图标的简单方式，可以快速获取网站的图标。
  link: https://chrome.google.com/webstore/detail/jlfeffjhgmgblofcgpbgpkkhfniipejm

- icon: 'https://favicon.liubing.me/itab.link.png'
  name: iTab
...
- icon: 'https://favicon.liubing.me/octotree.io.png'
  name: Octotree
  desc: GitHub code tree。
  link: https://octotree.io/

- icon: 'https://favicon.liubing.me/www.littlestarcloud.com.png'
  name: Little Star
...
- icon: 'https://favicon.liubing.me/webmaker.app.png'
  name: Web Maker
  desc: 浏览器中可离线的运行的代码编辑器。
  link: https://webmaker.app/

- icon: 'https://favicon.liubing.me/courier.toptopn.com.png'
  name: 网页更新提醒
