...
- icon: '@websites/webmaker.png'
  name: Web Maker
  desc: 浏览器中可离线的运行的代码编辑器。
  link: https://webmaker.app/

- icon: '@websites/courier.png'
  name: 网页更新提醒
