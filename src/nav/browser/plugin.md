...
```yaml
- icon: 'https://api.liubing.me/favicon/devtools.vuejs.org.png'
  name: Vue Devtools
  desc: Vue 项目开发调试工具。
  link: https://devtools.vuejs.org/

- icon: 'https://api.liubing.me/favicon/baidufe.com.png'
  name: FeHelper
  desc: 内置N多实用的工具。
  link: https://baidufe.com/fehelper/index/index.html

- icon: 'https://api.liubing.me/favicon/bitwarden.com.png'
  name: Bitwarden
  desc: 免费密码管理器，关键完全开源，可以自己搭建服务。
  link: https://bitwarden.com/

- icon: 'https://api.liubing.me/favicon/tampermonkey.net.png'
  name: Tampermonkey(油猴)
  desc: 不必多介绍了，神级插件。
  link: https://tampermonkey.net/

- icon: 'https://api.liubing.me/favicon/getadblock.com.png'
  name: AdBlock
  desc: 老牌广告拦截插件。
  link: https://getadblock.com/

- icon: 'https://api.liubing.me/favicon/wappalyzer.com.png'
  name: Wappalyzer
  desc: 一款能够分析目标网站所采用的技术的插件。
  link: https://wappalyzer.com/

- icon: 'https://api.liubing.me/favicon/chrome.google.com.png'
  name: 网站图标探测器
  desc: 探测网站图标的简单方式，可以快速获取网站的图标。
  link: https://chrome.google.com/webstore/detail/jlfeffjhgmgblofcgpbgpkkhfniipejm

- icon: 'https://api.liubing.me/favicon/itab.link.png'
  name: iTab
...
- icon: 'https://api.liubing.me/favicon/github.com.png'
  ...
  link: https://github.com/jiacai2050/gooreplacer

- icon: 'https://api.liubing.me/favicon/octotree.io.png'
  name: Octotree
  desc: GitHub code tree。
  link: https://octotree.io/

- icon: 'https://api.liubing.me/favicon/www.littlestarcloud.com.png'
  name: Little Star
...
- icon: 'https://api.liubing.me/favicon/webmaker.app.png'
  name: Web Maker
  desc: 浏览器中可离线的运行的代码编辑器。
  link: https://webmaker.app/

- icon: 'https://api.liubing.me/favicon/courier.toptopn.com.png'
  name: 网页更新提醒
