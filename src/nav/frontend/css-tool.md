...
```yaml
- icon: 'https://favicon.liubing.me/sass-lang.com.png'
  name: Sass
  desc: Sass 是成熟、稳定、强大的 CSS 扩展语言。
  link: https://sass-lang.com/
  github: https://github.com/sass/sass

- icon: 'https://favicon.liubing.me/lesscss.org.png'
  name: Less
  desc: Less（Leaner Style Sheets 的缩写）是一门向后兼容的 CSS 扩展语言。
  link: https://lesscss.org/
  github: https://github.com/less/less.js

- icon: 'https://favicon.liubing.me/stylus-lang.com.png'
  name: Stylus
  desc: 富于表现力、动态的、健壮的 CSS。
  link: https://stylus-lang.com/
  github: https://github.com/stylus/stylus

- icon: 'https://favicon.liubing.me/css-tricks.com.png'
  name: CSS-Tricks
  desc: 一个关于运用CSS技术进行网络开发和设计的小技巧的交流网站。
  link: https://css-tricks.com/

- icon: 'https://favicon.liubing.me/liubing.me.png'
  name: CSS三角形生成器
  desc: 定义几个参数很方便的生成纯css代码的各种三角形。
  link: https://liubing.me/tools/css-triangle-generator.html

- icon: 'https://favicon.liubing.me/kovart.github.io/dashed-border-generator.png'
...
- icon: 'https://favicon.liubing.me/9elements.github.io/fancy-border-radius.png'
...
- icon: 'https://favicon.liubing.me/cubic-bezier.com.png'
  name: 贝塞尔曲线
  desc: 拖拽方式生成贝塞尔曲线参数。
  link: https://cubic-bezier.com/

- icon: 'https://favicon.liubing.me/easings.net.png'
  name: 缓动函数速查表
  desc: 缓动函数速查表。
  link: https://easings.net/zh-cn
  github: https://github.com/ai/easings.net

- icon: 'https://favicon.liubing.me/grabient.com.png'
  name: Grabient
  desc: CSS 代码渐变颜色生成工具。
  link: https://grabient.com/
  github: https://github.com/johnkorzhuk/grabient

- icon: 'https://favicon.liubing.me/webgradients.com.png'
  name: Fresh Background Gradients
  desc: CSS 个性渐变背景集合。
  link: https://webgradients.com/
  github: https://github.com/itmeo/webgradients

- icon: 'https://favicon.liubing.me/whirl.netlify.app.png'
  name: Fresh Background Gradients
  desc: 创建各样的 CSS 加载动画。
  link: https://whirl.netlify.app/
  github: https://github.com/jh3y/whirl

- icon: 'https://favicon.liubing.me/codemyui.com.png'
  name: Codemyui
  desc: 非常酷的网站，有一堆很酷的 CSS、HTML 和 Javascript 片段。
  link: https://codemyui.com/

- icon: 'https://favicon.liubing.me/shadows.brumm.af.png'
  name: Smooth Shadow
  desc: 一款设置漂亮阴影的工具。
  link: https://shadows.brumm.af/

- icon: 'https://favicon.liubing.me/box-shadow.art.png'
  name: Box Shadow
  desc: 提供各种阴影样式。
  link: https://box-shadow.art/

- icon: 'https://favicon.liubing.me/colorhunt.co.png'
  name: Color Hunt
  desc: 非常受欢迎的配色网站，提供了大量的精选颜色方案。
  link: https://colorhunt.co/

- icon: 'https://favicon.liubing.me/glassgenerator.netlify.app.png'
  name: Glass Morphism
  desc: 在线CSS毛玻璃风格工具。
  link: https://glassgenerator.netlify.app/
  github: https://github.com/daniektj/Glass-Morphism-Generator

- icon: 'https://favicon.liubing.me/keyframes.app.png'
  name: Keyframes
  desc: 在线动画、阴影和颜色。
  link: https://keyframes.app/
  github: https://github.com/mitchas/keyframes

- icon: 'https://favicon.liubing.me/bgjar.com.png'
  name: BGJar
  desc: 一个免费的在线背景生成器，提供了各种类型和风格的背景图像。
  link: https://bgjar.com/

- icon: 'https://favicon.liubing.me/magicpattern.design.png'
  name: SVG Chart Generator
  desc: 一款设计精美的图表生成器，生成基于 SVG 的折线或条形格式的图表。
  link: https://magicpattern.design/tools/svg-chart-generator

- icon: 'https://favicon.liubing.me/css-generators.com.png'
  name: Ribbon Shapes
...
- icon: 'https://favicon.liubing.me/venngage.com.png'
...
```yaml
- icon: 'https://favicon.liubing.me/animista.net.png'
  name: Animista
  desc: 一个可自定义的 CSS 动画库工具
  link: https://animista.net/

- icon: 'https://favicon.liubing.me/cssload.net.png'
  name: CSS Load
  desc: 纯 CSS 生成各种 Loading 加载动画。
  link: https://cssload.net/

- icon: 'https://favicon.liubing.me/css-loaders.com.png'
  name: CSS Loaders
