...
```yaml
- icon: 'https://api.liubing.me/favicon/sass-lang.com.png'
  name: Sass
...
- icon: 'https://api.liubing.me/favicon/liubing.me.png'
  name: CSS三角形生成器
  desc: 定义几个参数很方便的生成纯css代码的各种三角形。
  link: https://liubing.me/tools/css-triangle-generator.html

- icon: 'https://api.liubing.me/favicon/kovart.github.io/dashed-border-generator.png'
...
- icon: 'https://api.liubing.me/favicon/easings.net.png'
  name: 缓动函数速查表
  desc: 缓动函数速查表。
...
- icon: 'https://api.liubing.me/favicon/shadows.brumm.af.png'
  name: Smooth Shadow
  desc: 一款设置漂亮阴影的工具。
  link: https://shadows.brumm.af/

- icon: 'https://api.liubing.me/favicon/box-shadow.art.png'
  name: Box Shadow
  desc: 提供各种阴影样式。
...
- icon: 'https://api.liubing.me/favicon/glassgenerator.netlify.app.png'
  name: Glass Morphism
  desc: 在线CSS毛玻璃风格工具。
...
- icon: 'https://api.liubing.me/favicon/venngage.com.png'
...
```yaml
- icon: 'https://api.liubing.me/favicon/animista.net.png'
  name: Animista
  desc: 一个可自定义的 CSS 动画库工具
  link: https://animista.net/

- icon: 'https://api.liubing.me/favicon/cssload.net.png'
  name: CSS Load
  desc: 纯 CSS 生成各种 Loading 加载动画。
  link: https://cssload.net/

- icon: 'https://api.liubing.me/favicon/css-loaders.com.png'
  name: CSS Loaders
