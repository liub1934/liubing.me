...
```yaml
- icon: 'https://favicon.liubing.me/vant.pro.png'
  name: Vant
  desc: 轻量、可靠的移动端 Vue 组件库。
  link: https://vant.pro/vant/
  github: https://github.com/vant-ui/vant

- icon: 'https://favicon.liubing.me/nutui.jd.com.png'
  name: Naive UI
...
- icon: 'https://favicon.liubing.me/varletjs.org.png'
  name: VARLET
  desc: 一个基于 Vue3 开发的 Material 风格移动端组件库。
  link: https://varletjs.org/
  github: https://github.com/varletjs/varlet

- icon: 'https://favicon.liubing.me/didi.github.io/mand-mobile.png'
  name: Mand Mobile
...
- icon: 'https://favicon.liubing.me/quark-ecosystem.github.io/quarkd-docs.png'
  name: Quark Design
...
- icon: 'https://favicon.liubing.me/mini.ant.design.png'
  name: Ant Design Mini
  desc: 探索移动端小程序的极致体验。
  link: https://mini.ant.design/
  github: https://github.com/ant-design/ant-design-mini

- icon: 'https://favicon.liubing.me/tdesign.tencent.com.png'
...
- icon: 'https://favicon.liubing.me/weapp-tw.icebreaker.top.png'
