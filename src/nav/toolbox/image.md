...
- icon: 'https://api.liubing.me/favicon/svgtopng.com.png'
  name: SVG to PNG
...
- icon: 'https://api.liubing.me/favicon/cloudconvert.com.png'
  name: CloudConvert
  desc: 文件转换器，将您的文件转换成任意格式。
...
- icon: 'https://api.liubing.me/favicon/iloveimg.com.png'
  name: iLoveIMG
...
- icon: 'https://api.liubing.me/favicon/tt0.top.png'
  name: 踢踢零动图
